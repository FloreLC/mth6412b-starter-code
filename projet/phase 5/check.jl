...
filename = "tokyo-skytree-aerial"#ARGS[2]
...
@show size(tour_out)
write_tour(PROJECT_PATH * "/phase 5/shredder-julia/tsp/tours/$(filename)_optimal.tour", tour_out, score_picture(PROJECT_PATH * "/phase 5/shredder-julia/images/shuffled/$(filename).png"))
